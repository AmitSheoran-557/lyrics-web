...
const SongsList = () => {
    ...
    return (
        <div className='flex flex-col justify-center items-center pb-11 bg-off-white-two'>
                ...
                <div className="flex flex-wrap w-full mx-auto">
                    <div className="lg:w-8/12 w-full mx-auto justify-center max-lg:flex max-lg:flex-col max-lg:items-center">
                        <div className="max-w-[774px] w-full">
                            <h2 className='font-semibold xl:text-5xl !leading-[120%] lg:text-4xl md:text-3xl text-2xl text-start'>Songs</h2>
                        ...
                        <div className="max-w-[774px] w-full xl:space-y-11 lg:space-y-9 md:space-y-7 space-y-5" >
                            {SONGS_LIST.slice(1).map((song, index) => (
                                <div key={index} className="flex flex-wrap" >
                                    ...
                                    <div className='w-3/12 lg:justify-center flex'><p className='text-xs !leading-[171%] text-light-brown'>{song.date}</p></div>
                                    <div className='w-3/12 lg:justify-end justify-center flex'><p className='text-xs !leading-[171%] text-light-brown'>{song.playedTime}</p></div>
                                </div>
                            ))}
                        </div>
                    </div>
                    <div className="lg:w-4/12 w-full lg:ps-10 lg:pt-6 justify-center flex max-lg:mt-6">
